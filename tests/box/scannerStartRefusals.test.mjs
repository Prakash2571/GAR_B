 ...
 * CalSpread where they were correct and in GTS Box were not:
 *
 *   1. It said "Box persistence is not configured (set MONGODB_URI)". In GTS Box
 ...
 *
 *   2. It said "Connect to Zerodha before starting the box scanner". GTS Box runs
